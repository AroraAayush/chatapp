...
class CustomCommunityNameTextField extends StatelessWidget {
  ...
  CustomCommunityNameTextField({super.key,required this.controller, required this.what, this.prefixIcon, this.suffixIcon, this.validator, this.suffixIconTapped});
    ...
    return  Padding(
      ...
      child: Container(
        ...
        TextFormField(
          onChanged: (val)
          {
            communityController.communityname.value=val;
          },
