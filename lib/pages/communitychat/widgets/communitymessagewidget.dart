...
class CommunityMessageWidget extends StatefulWidget {
  final CommunityMessageModel msg;
  final String msgId;
  final List<dynamic> members;
  CommunityMessageWidget({super.key,required this.msg,required this.msgId,required this.members});
...
class _CommunityMessageWidgetState extends State<CommunityMessageWidget> {
  final communityChatControlller=Get.put(CommunityController());

  @override
  void initState() {
    updateIsReadStatus(widget.msgId,widget.msg.communityId);
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    bool isSender=(communityChatControlller.auth.currentUser!.uid== widget.msg.senderId);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            children: [
              widget.msg.isStarred.contains(communityChatControlller.auth.currentUser!.uid)?
              Padding(
              ...
              widget.msg.senderId==communityChatControlller.auth.currentUser!.uid?
              Padding(
  ...
  void updateIsReadStatus(String msgId,String roomId) async{
    if(widget.msg.isRead==false && widget.msg.senderId!=communityChatControlller.auth.currentUser!.uid)
    {
